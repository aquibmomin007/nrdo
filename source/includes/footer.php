        <footer>
            <div class="wrapper">
                <section class="footer-logo">
                    <a href="http://www.hpb.gov.sg/" target="_blank"><img src="/assets/img/foot1.png" alt="foot1" /></a><!--
                 --><a href="http://www.moh.gov.sg/" target="_blank"><img src="/assets/img/foot2.png" alt="foot2" /></a>
                </section>    
                <section class="foot-links">
                    <ul class="foot-list">
                        ...
                        <li><a href="/data_enquiry/index.php" class="request">Enquiry Request</a></li>
                        <li><a href="/data_enquiry/index.php" class="general">General Enquiry</a></li>                                             
                    </ul> 
                </section>
